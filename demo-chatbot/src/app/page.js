...
import AssistantBubble from "../components/assistant_message";
import UserBubble from "../components/user_message";
...
export default function Home() {
  ...
  const sendMessage = async () => {
    ...
    // Build the new messages array including the user message
